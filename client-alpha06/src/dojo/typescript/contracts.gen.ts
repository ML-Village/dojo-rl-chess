...
export async function setupWorld(provider: DojoProvider) {
    ...
    function lobby() {
        ...
        const register_player = async (props: { account: Account, name: string, profile_pic_type: models.ProfilePicType, profile_pic_uri: string }) => {
            try {
                return await provider.execute(
                    props.account,
                    {
        ...
        const update_player = async (props: { account: Account, name: string, profile_pic_type: models.ProfilePicType, profile_pic_uri: string }) => {
            try {
                return await provider.execute(
                    props.account,
                    {
